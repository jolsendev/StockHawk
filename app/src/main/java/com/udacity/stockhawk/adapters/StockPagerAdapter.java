...
public class StockPagerAdapter extends PagerAdapter implements View.OnClickListener {
    ...
    private TextView btnOneMonthButton;
    private TextView btnThreeMonthButton;
    private TextView btnSixMonth;
    private TextView btnOneYear;
    private View lineChartView;
    private Uri mUri;
    private String mSymbol;
    private String mParam1;
    private LinkedHashMap<Integer, String> stockDateIndex;
    private ArrayList<Object> yAxesQuote;
    private String sharedPref;
    private int prefRange;

    public StockPagerAdapter(Context context, Cursor cursor){
